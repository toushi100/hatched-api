...
@Entity("actual_budget_month_ratio")
export class ActualBudgetMonthRatioEntity extends AbstractEntity {
    @PrimaryGeneratedColumn({
        name: "actual_budget_month_ratio_id",
    })
    @Expose()
    id: number;
    ...
    @OneToMany(() => ActualBudgetMonthEntity, (actualBudgetMonth) => actualBudgetMonth.actualBudgetMonthRatio)
